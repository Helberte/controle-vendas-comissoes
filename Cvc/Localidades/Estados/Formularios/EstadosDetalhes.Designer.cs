namespace controle_vendas_comissoes.Cvc.Localidades.Estados.Formularios
{
    partial class EstadosDetalhes
    {
        ...
        private void InitializeComponent()
        {
            ...
            btSalvarMais.Location = new Point(558, 76);
            ...
            maskUF.Location = new Point(400, 77);
            maskUF.Mask = "AAAA";
            ...
            btSalvar.Icon = null;
            btSalvar.Location = new Point(668, 76);
            ...
            btCancelar.Location = new Point(668, 131);
            ...
            MaximizeBox = false;
            MaximumSize = new Size(782, 187);
            MinimizeBox = false;
            MinimumSize = new Size(782, 187);
            Name = "EstadosDetalhes";
            Sizable = false;
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Detalhes do Estado";
            ResumeLayout(false);
        }
